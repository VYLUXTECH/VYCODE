...
const TIPS: Tip[] = [
  ...
  "Run {highlight}/share{/highlight} to create a public vycode.ai link",
  ...
  "Create a plugin to prevent VYCODE from reading sensitive files",
  "Use {highlight}vycode run{/highlight} for non-interactive scripting",
  "Use {highlight}vycode --continue{/highlight} to resume the last session",
  "Use {highlight}vycode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}vycode serve{/highlight} for headless API access to VYCODE",
  "Use {highlight}vycode run --attach{/highlight} to connect to a running server",
  "Run {highlight}vycode upgrade{/highlight} to update to the latest version",
  "Run {highlight}vycode auth list{/highlight} to see all configured providers",
  "Run {highlight}vycode agent create{/highlight} for guided agent creation",
  "Use {highlight}/vycode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}vycode github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/vycode fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}vycode debug config{/highlight} to troubleshoot configuration",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/VYLUXTECH/VYCODE{/highlight} in a container",
  "Use {highlight}/connect{/highlight} with VYCODE Zen for curated, tested models",
